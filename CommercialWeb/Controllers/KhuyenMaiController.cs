...
namespace CommercialWeb.Controllers
{
    ...
    public class KhuyenMaiController : Controller
    {
        ...
        {
            IEnumerable<SanPham> lstSP = db.SanPhams.Where(n => (n.TenSP.Contains(sTuKhoa) || n.KhuyenMai.TenKhuyenMai.Contains(sTuKhoa)) && n.MaKhuyenMai != 1);
